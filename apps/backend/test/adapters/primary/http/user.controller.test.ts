...
describe('UserController', () => {
  ...
  describe('register()', () => {
    describe('successful registration', () => {
      it('should register a new user successfully', async () => {
        ...
        const mockResult = { userId: 'user-123-abc', access_token: 'mock.jwt.token', token_type: 'Bearer', expires_in: 3600 }
      ...
      it('should handle different valid user data', async () => {
        ...
        const mockResult = { userId: 'user-456-xyz', access_token: 'mock.jwt.token', token_type: 'Bearer', expires_in: 3600 }
        vi.mocked(mockRegisterUserUseCase.execute).mockResolvedValue(mockResult)
  ...
  describe('integration', () => {
    it('should handle complete registration flow', async () => {
      ...
      const mockResult = { userId: 'user-integration-123', access_token: 'mock.jwt.token', token_type: 'Bearer', expires_in: 3600 }
      vi.mocked(mockRegisterUserUseCase.execute).mockResolvedValue(mockResult)
    ...
    it('should maintain context when routes are called', async () => {
      ...
      const mockResult = { userId: 'user-123', access_token: 'mock.jwt.token', token_type: 'Bearer', expires_in: 3600 }
      vi.mocked(mockRegisterUserUseCase.execute).mockResolvedValue(mockResult)

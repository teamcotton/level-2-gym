...
export class User {
   ...
   * const user = new User(undefined, email, password, 'John Smith', role)
   * // For existing users, provide ID
   * const existingUser = new User('user-456', email, password, 'John Smith', role)
   * ```
   */
  constructor(
